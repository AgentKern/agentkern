...
3. **Deploy** the Enterprise Software within your organization

### Restrictions

You may NOT:

1. **Distribute** the Enterprise Software to third parties
2. **Sublicense** the Enterprise Software
3. **Use** the Enterprise Software to provide a competing managed service
...
You may evaluate the Enterprise Software for up to 30 days without a license. After this period, you must either purchase a license or cease using the Enterprise Software.

### No Warranty

THE ENTERPRISE SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTY OF ANY KIND.
