# VeriMantle Licensing Strategy: The "Ghost Kernel" Model
...
*   **`@verimantle/sdk`**: The developer interface.
*   **`@verimantle/identity`**: The passport protocol.
*   **`verimantle-core` (The Binary)**: The single-node Rust binary. Developers can run a "Local Cell" on their laptop for free.

**Why?**
*   **Developer Addiction**: If `npm install verimantle` works instantly, devs will use it.
