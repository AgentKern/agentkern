...
impl GateMetricsExporter {
    ...
    pub fn record_context_scan(&self, chunks_scanned: u64, chunks_flagged: u64, rejected: bool) {
        ...
        self.context_chunks_scanned
            .fetch_add(chunks_scanned, Ordering::Relaxed);
        self.context_chunks_flagged
            .fetch_add(chunks_flagged, Ordering::Relaxed);
        if rejected {
    ...
    pub fn summary(&self) -> MetricsSummary {
        ...
        MetricsSummary {
            ...
            wasm_avg_latency_us: if wasm_latencies.is_empty() {
                0
            } else {
            ...
            prompt_avg_latency_us: if prompt_latencies.is_empty() {
                0
            } else {
